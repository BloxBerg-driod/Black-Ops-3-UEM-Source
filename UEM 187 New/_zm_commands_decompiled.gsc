...
function private function_45e81b43()
{
	...
	if(isdefined(1) && 1)
	{
		function_a4869edc("EnableCommands", "enablecommands", "Enables/Disables the Console Commands [Includes Flag]", &function_280d6e2c, &function_cc7982f7, "option_on_off", undefined, array("off", "deactivate", "disable", "0"));
	}
	while(!(isdefined(level flag::get("dev_console_commands")) && level flag::get("dev_console_commands")))
	{
		wait(0.5);
	}
	...
	function_a4869edc("debugmode", "debug", "Enables debug mode for the Console Commands [Debug Flag]", &function_826ee655, &function_4b2b0ac, "option_on_off", array("on", "activate", "enable", "1"), array("off", "deactivate", "disable", "0"));
	function_a4869edc("silentdev", "silent", "Silences the Iprints to only send to host", &function_9cd31ee3, &function_b8c52a6e, "option_on_off", array("on", "activate", "enable", "1"), array("off", "deactivate", "disable", "0"));
	function_a4869edc("fullsilentdev", "full_silent", "Silences the Iprints", &function_448ef885, &function_280bc2dc, "option_on_off", array("on", "activate", "enable", "1"), array("off", "deactivate", "disable", "0"));
...
function function_fc027bc0(var_34d37a48)
{
	switch(var_34d37a48["value"][0])
	{
		...
		default
		{
			if(isdefined(level.zombie_weapons[getweapon(var_34d37a48["value"][0])]) || isdefined(level.zombie_weapons[getweapon(var_34d37a48["value"][0])]))
			{
			...
			{
				function_957b7937("No such weapon exists. Make sure to spell correctly!");
			}
		}
	}
	return;
