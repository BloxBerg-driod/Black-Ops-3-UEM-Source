...
{
	namespace_system::function_register("zm_perk_random_uem", &function___init__, &function___main__, undefined);
}
...
function function_grab_check(var_player, var_random_perk)
{
	...
	var_player.var_pers["wunderfizz_used"]++;
	var_player thread namespace_97ac1184::function_1d39abf6("end_game_wunderfizz_used", 1, 0);
	var_player thread namespace_97ac1184::function_7e18304e("spx_save_data", "wunderfizz_used", var_player.var_pers["wunderfizz_used"], 0);
